...
<head>
<title>Targeting Dashboards</title>
</head>
...
<iframe id="iframeDisplay" style="border:none; position:fixed; top:0; left:0; width:100%; height:100vh;" src="https://favstats.github.io/elex/docs/map/NL"></iframe>
...
<script>
  ...
  window.onload = function() {
    ...
    if(iframeDisplay.src.length > maxLength) {
      iframeDisplay.src = 'https://favstats.github.io/elex/docs/map/NL';
    }
    ...
    if(iframeSelector) {
      ...
      iframeSelector.addEventListener('change', function() {
        ...
        iframeDisplay.src = `https://favstats.github.io/elex/docs/${selectedOption}`;
